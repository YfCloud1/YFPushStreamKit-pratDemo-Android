...
import com.yunfan.encoderdemo.ui.widget.banner.listener.OnBannerClickListener;
import com.yunfan.encoderdemo.ui.widget.banner.listener.OnBannerListener;
import com.yunfan.encoderdemo.ui.widget.banner.loader.ImageLoaderInterface;
import com.yunfan.encoderdemo.ui.widget.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    public Banner(Context context, AttributeSet attrs, int defStyle) {
        ...
        indicatorSize = dm.widthPixels / 60;
...
//        Log.i(tag, ev.getAction() + "--" + isAutoPlay);
    ...
    public Banner configIndicatorMargin(int margin){
