package com.yunfan.encoderdemo.ui.widget.indicator;
...
public class CircleIndicator extends LinearLayout {
    ...
    private int mAnimatorResId = R.animator.scale_with_alpha_indicator;
    private int mAnimatorReverseResId = 0;
    private int mIndicatorBackgroundResId = R.drawable.white_radiu;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.white_radiu;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mAnimatorResId = typedArray.getResourceId(R.styleable.CircleIndicator_ci_animator,
                R.animator.scale_with_alpha_indicator);
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha_indicator, 0, R.drawable.white_radiu, R.drawable.white_radiu);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mAnimatorResId = (mAnimatorResId == 0) ? R.animator.scale_with_alpha_indicator : mAnimatorResId;
